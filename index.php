...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">DATA SERVICE CENTER IT FIELD SUPPORT JOGJA</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
    ...
    <div class="modal fade" id="detail" tabindex="-1" aria-labelledby="detail" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body text-center" id="detail-gerai">
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <u style="color: #fff;">Raden Iman Setio Nugroho</u></p>
    </footer>
    <!-- Close Footer -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.detail').click(function() {
                var dataGerai = $(this).attr("data-id");
                $.ajax({
                    url: "detail.php",
                    method: "post",
                    data: {
